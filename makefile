...
all:
	...
	i686-elf-g++ -m32 -nostdlib -ffreestanding -std=c++11 -mno-red-zone -fno-exceptions -nostdlib  built/loader.o kernel/kernel.cpp built/gdt.o built/int.o -o built/main.o -T linker.ld
