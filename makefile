...
all:
	...
	i686-elf-g++ -m32 -nostdlib -ffreestanding -Wno-write-strings -std=c++14 -mno-red-zone -fno-exceptions -nostdlib  built/loader.o kernel/kernel.cpp built/gdt.o built/int.o -o built/main.o -T linker.ld
